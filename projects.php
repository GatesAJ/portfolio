...
<body>
    ...
    <div id="parser">
        ...
        &nbsp the Company's Database for later use. 
    </div>
    ...
    <div id="pageEdit">
        ...
        &nbsp edit the page to include more info to be displayed to the employees. This was done by using SQL to gather the information and tables to display the new information.
    </div>
    ...
    <div id="mobile">
        ...
        &nbsp or at least trigger them. These two apps though were never published to the Play Store.
    </div>
